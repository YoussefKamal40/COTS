...
#define CUH_CONNECTION_DEFAULT			0
#define	CUH_CONNECTION_REMAPED			1
...
#define CUH_ASYNC_MODE_DMA 			USART_DMA_ASYNC_MODE
#define CUH_ASYNC_MODE_INTERRUPT 	USART_INTERRUPT_ASYNC_MODE
